 ...
 */
export const findFullExport = (filters: { desde?: string; hasta?: string } = {}) => {
 ...
 * @param {{ desde?: string, hasta?: string }} filters
 */
export const findSummary = (filters: { desde?: string; hasta?: string } = {}) => {
    const { desde, hasta } = filters;
    return db.query(
        `SELECT 
 ...
 */
export const findByPaymentMethod = (filters: { desde?: string; hasta?: string } = {}) => {
    const { desde, hasta } = filters;
    return db.query(
        `SELECT 
 ...
 */
export const findByDay = (filters: { desde?: string; hasta?: string } = {}) => {
    const { desde, hasta } = filters;
    return db.query(
        `SELECT 
